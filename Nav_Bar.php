...
<nav class="navbar navbar-expand-lg navbar-light row m-auto" role="navigation">
			...
			<div class="col-lg-7  m-auto" align="center">
				<ul class="navbar-nav">
    				...
    				<li class="nav-item border-bottom-0 nav-item <?php echo $styles; ?>"  id="nav_tabs">
    					<a class="nav-link nav-link" href="Styles_Page.php">Styles</a>
    				</li>
                    ...
                    <li class="nav-item border-bottom-0" style="margin:30px" >
						...
						?>
                        	<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                            	...
                            	style="font-weight:600; padding-left:25px; padding-right:25px; border-radius:30px;">Sing In</button>
                            </form>
						<?php
