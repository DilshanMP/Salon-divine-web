    ...
    <?php
		...
		if(!empty($_FILES['styleImage']['name'])){
				...
				if(in_array($ext[1],$extType)){
					...
					$SQL = "UPDATE `styles` SET `name`='".$s_name."',`price`=".$s_price.",`style_img`='".$image."',`category`='".                    $category."', `description`='".$description."', `suitable_hair_types`='".$hairTypes."', 
			...
			if($row= mysqli_fetch_row($result)){
				...
				if($s_name!= $row[1] || $s_price!= $row[2] || $category!="Not_Set" || $description!=$row[5] || $hairTypes!=$row[6] 
				...
				|| $dressTypes!=$row[7] || $occasion!=$row[8]){
					...
					`suitable_hair_types`= '".$hairTypes."', `matching_dresses`= '".$dressTypes."', 
   		...
   		<?php
			...
			if(!empty($_FILES['style_Image']['name'])){
				...
				if(in_array($ext[1],$extType)){
					...
					'".$description."', '".$hairTypes."', '".$dressTypes."', '".$occasion."')";
...
<!-- style manager content -->  
        				...
        				<div class="row">
                			...
                			<div class="style__details col-lg-6" style="text-align:right">
                    			...
                    			<div>
                                    ...
                                    <input type="text" name="txtHairType" value="<?php echo $row[6]; ?>" 
   ...
   <?php } ?>>
    	...
    	<div class="col-lg-5 col-md-8 col-sm-12 m-auto" align="center">
            ...
            <div class="feild">
            	<div>
            	<label class=" flb">Suitable Hair Types</label>
                </div>
				<input type="text" class="p_input" name="txtHairTypes" required="required" placeholder="Hair Types" 
                value="<?php echo $hairTypes;?>" maxlength="50"/>
